...
However, these online platforms where individuals have the freedom to write whatever and however they deem fit are equally hazardous as they can facilitate the spread of incorrect information. @VosoughiEtAl2018 found incorrect information to actually spread wider and faster on social media than its true counterpart. 



Thiscanresultinthespreadof false or harmful information, which can be a serious concern for both individuals and society. Social media is an important source for sentiment analysis because it is constantly growing, producing increasingly complex and connected data
