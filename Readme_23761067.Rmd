...
#### Figure 5: Variable Importance Plot of top 20 words in reviews identified by RandomForest model 
```{r vip}
...
#### Figure 6: Word cloud of top 50 words in reviews identified by RandomForest model
```{r rf wordcloud}
...
top_20 <- df_wordcloud[1:20,]

ols_data <- dtm %>%
  select(rating.x, top_20)
