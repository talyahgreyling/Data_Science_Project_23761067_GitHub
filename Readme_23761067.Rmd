...
* Unnested tokens (30 800 observations were recorded)
* Remove stop_words, numbers, punctuation and symbols (16 869 observations remaining)
```{r prepare data}

# Get data in clean token format 
data_clean <- data %>%
...
# Identify the most used words in reviews 
