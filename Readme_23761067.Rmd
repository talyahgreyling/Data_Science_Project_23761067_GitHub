...
df1 <- data.frame(
    Variable = c("id", "rating", "note", "language", "user_is_featured", "user_is_premium", "user_statistics_followers_count"), 
...
# Draw wordcloud
fig6 <- wordcloud2(df_wordcloud, size = 1.2, color = palette, backgroundColor = "white")
