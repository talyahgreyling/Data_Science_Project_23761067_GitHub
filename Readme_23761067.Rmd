...
```{r headdata, results = 'asis', echo = FALSE}
...
table1 <- kable(datatab1, format = "html", booktabs = TRUE, linesep = "", caption = "") %>%
  kable_styling(bootstrap_options = "none", full_width = FALSE, font_size = 12) %>%
...
table2 <- print(xtable(df1),
                    type = "html",
                    include.rownames = TRUE,  
                    print.results = FALSE)     

# Display in R Markdown (HTML output)
table2
