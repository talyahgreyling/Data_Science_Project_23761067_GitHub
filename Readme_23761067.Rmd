...
fig1 <- ggplot(review_tokens, aes(x = rating)) +
  geom_histogram(aes(y = ..density..), binwidth =0.5, bins = 30, fill = "#3A7370", color = "black", alpha = 1) +
  geom_density(fill = "#CE677A", alpha = 0.5)+
  theme_minimal()
fig1
